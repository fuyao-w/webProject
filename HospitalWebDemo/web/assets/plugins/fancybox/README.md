...
Load files in the <head> section of your HTML document. Make sure you also add the jQuery library.
    ...
    <head>
        <script type="tool.text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.7/jquery.min.js"></script>
        <link rel="stylesheet" href="/fancybox/jquery.fancybox.css" type="tool.text/css" media="screen" />
        <script type="tool.text/javascript" src="/fancybox/jquery.fancybox.pack.js"></script>
    </head>
